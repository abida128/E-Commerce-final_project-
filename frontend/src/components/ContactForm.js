  ...
  return (
    <div className="flex">
      ...
      <div className="w-1/2 p-4">
        ...
        <div className="mb-4">
          <hr className="border-t-2 border-orange-500 h-px w-1/4 my-4" /> {/* Smaller horizontal line */}
      ...
      <div className="w-1/2 p-4">
        <div className="mb-4">
          <h2 className="text-3xl font-extrabold text-orange-500">Ask Your Queries</h2>
